...
const bibleDataEn = rawBibleDataEn;
const bibleDataId = rawBibleDataId;
// Convert data for both languages
export const versesEn = convertToVerseArray(bibleDataEn, "en");
export const versesId = convertToVerseArray(bibleDataId, "id");
// Add metadata about the source
export const bibleMetadata = {
    version: "Demo Version",
    description: "A demonstration Bible API with selected verses for educational purposes",
    license: "MIT",
    lastUpdated: new Date().toISOString(),
    disclaimer: "This is a limited dataset for demonstration purposes only. For complete Bible text, please refer to public domain sources or licensed Bible translations.",
